...
class LoginForm(FlaskForm):
    username = StringField('Username', render_kw={'placeholder': 'raojingpeng'}, validators=[DataRequired('名字不能为空！')])
    password = PasswordField('Password', validators=[DataRequired('密码不能为空！'), Length(8, 128)])
